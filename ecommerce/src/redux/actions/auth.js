...
import { ACTIVATION_FAIL, ACTIVATION_SUCCESS, REMOVE_AUTH_LOADING, SET_AUTH_LOADING, SIGNUP_SUCCESS, SIGN_FAIL, LOGIN_SUCCESS,
    LOGIN_FAIL, USER_LOADED_SUCCESS, USER_LOADED_FAIL,AUTHENTICATED_SUCCESS, AUTHENTICATED_FAIL, REFRESH_SUCCESS , REFRESH_FAIL, LOGOUT,  RESET_PASSWORD_SUCCESS,
    RESET_PASSWORD_FAIL, RESET_PASSWORD_CONFIRM_SUCCESS, RESET_PASSWORD_CONFIRM_FAIL, } from "./types";
...
export const logout = () => async dispatch =>{
    ...
    dispatch(setAlert('Logged Exitoso', 'green'))
}
